  ...
  return (
    <div>
      ...
      <div>
        ...
        <form onSubmit={(e) => { e.preventDefault() }} className='w-1/4 absolute p-12 bg-black my-36 mx-auto left-0 right-0 text-white rounded-lg bg-opacity-80'>
          ...
          <button className='p-2 my-2 bg-red-700 w-full rounded-lg' onClick={handleButtonClick} >{isSignInForm ? "Sign In" : "Sign Up"}</button>
